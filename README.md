...
### victim selection
### segment selection
when there is no free block for a current segment, f2fs will select a new segment. if there is need for SSR(Slack Space Recycling), f2fs will select a segment from dirty segments, or else f2fs will select a segment from free segments.
