  ...
  <td>
    <ol>
      ...
      <ul>
        ...
        <li>the other entries (InlineDataAddrs) are used to store addresses of inlined file data
      </ul>
...
<tr valign="top">
  ...
  <td>
    <ol>
      <li>SIT is organized in 4K sized blocks, an SIT block accommodates 55 SIT entries</li>
